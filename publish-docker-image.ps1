...
$RunCommand = "docker run --name gpt-image-1-playground -p 3366:3366 -e OPENAI_API_KEY=your-openai-api-key -e IMAGE_API_MODE=proxy -e PROXY_BASE_URL=https://sample-auth-proxy.wus2.sample-dev.azgrafana-test.io -e PROXY_API_VERSION=2025-04-01-preview $FullImageNameVersioned"
Write-Host ""
